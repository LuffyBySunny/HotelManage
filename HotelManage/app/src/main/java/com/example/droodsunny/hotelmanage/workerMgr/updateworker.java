...
public class updateworker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updateworker);
                ...
                try {
                    ...
                    while (cursor.moveToNext()) {
                        if (name.equals(cursor.getString(1))) {
                            WorkerMgrCT.updateUser(db, name, age, tel, pwd, sex, power);
                            Toast.makeText(updateworker.this, "更新成功", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                    Toast.makeText(updateworker.this,"输入名字有误",Toast.LENGTH_SHORT).show();
                }catch (Exception e){
                    Toast.makeText(updateworker.this, "请输入完整", Toast.LENGTH_SHORT).show();
                }
