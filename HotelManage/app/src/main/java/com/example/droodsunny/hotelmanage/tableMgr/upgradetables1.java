...
public class upgradetables1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upgradetables1);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    while (cursor.moveToNext()) {
                        if (id.equals(cursor.getString(0))) {
                            ...
                            try {
                                ...
                                Toast.makeText(upgradetables1.this, "更新成功", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(upgradetables1.this, "更新失败", Toast.LENGTH_SHORT).show();
                }catch (Exception s){
                    Toast.makeText(upgradetables1.this, "输入有误", Toast.LENGTH_SHORT).show();
                }
