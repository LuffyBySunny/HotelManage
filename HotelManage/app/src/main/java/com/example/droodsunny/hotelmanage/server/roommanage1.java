...
public class roommanage1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roommanage1);
        ...
        arrayAdapter=new ArrayAdapter<String>(roommanage1.this,android.R.layout.simple_expandable_list_item_1,st);
        /*
        * 查看桌台
        **/
        ...
        * */
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(roommanage1.this,opentables.class);
